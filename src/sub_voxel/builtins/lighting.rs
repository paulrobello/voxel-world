...
pub fn create_torch() -> SubVoxelModel {
    ...
    log::debug!("[DEBUG] Torch model created:");
    log::debug!("  - Voxel count: {}/{}", voxel_count, model.voxels.len());
    log::debug!("  - Collision mask: 0x{:016x}", model.collision_mask);
    log::debug!("  - Resolution: {:?}", model.resolution);
