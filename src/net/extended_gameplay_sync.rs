...
mod tests {
    ...
    use crate::net::protocol::{FallingBlockLanded, FallingBlockSpawned, WaterCellUpdate};
    ...
    fn test_day_cycle_pause_sync_reliability() {
        ...
        let mut client1_paused = false;
        let mut client1_time: f32 = 0.25;
        let mut client2_paused = false;
        let mut client2_time: f32 = 0.25;
