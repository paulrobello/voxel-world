...
impl PaletteUI {
    fn palette_items_for_tab(
        ...
        const BLOCK_PALETTE: [BlockType; 42] = [
            BlockType::Stone,
            BlockType::Dirt,
            BlockType::Grass,
            BlockType::Planks,
        ...
        if matches!(tab, PaletteTab::Models | PaletteTab::All) {
            ...
            // Picture frame (auto-sizes up to 3×3). Sprite uses 1×1 preview.
            push_if(160, "Frame (Auto 1-3×1-3)");
    ...
    fn draw_palette_item(
        ...
        let uv_left = block_idx / crate::constants::ATLAS_TILE_COUNT_F32;
        let uv_right = (block_idx + 1.0) / crate::constants::ATLAS_TILE_COUNT_F32;
