                ...
                egui::ScrollArea::vertical()
                    ...
                    .show(ui, |ui| {
                        ...
                        if ui
                            ...
                            .changed()
                        {
                            log::debug!("[SETTING] Ray Steps: {}", settings.max_ray_steps);
                        }
                        if ui
                            .add(
                            ...
                            .changed()
                        {
                            log::debug!("[SETTING] Shadow Steps: {}", settings.shadow_max_steps);
                        }
                        if ui
                            ...
                            .changed()
                        {
                            log::debug!("[SETTING] View Distance: {} chunks", *view_distance);
                        ...
                        if ui
                            ...
                            .changed()
                        {
                            log::debug!("[SETTING] Load Distance: {} chunks", *load_distance);
                            // Ensure load distance is at least view distance
                            if *load_distance < *view_distance {
                                *load_distance = *view_distance;
                            }
                        ...
                        if ui
                            ...
                            .changed()
                        {
                            log::debug!("[SETTING] Unload Distance: {} chunks", *unload_distance);
                            // Ensure unload distance is greater than load distance
                            if *unload_distance <= *load_distance {
                                *unload_distance = *load_distance + 2;
                            }
                        ...
                        ui.collapsing("LOD Distances (lower = faster)", |ui| {
                            ui.horizontal(|ui| {
                                ...
                                if ui
                                    ...
                                    .changed()
                                {
                                    log::debug!("[LOD] AO distance: {:.0}", settings.lod_ao_distance);
                                }
                            });
                            ui.horizontal(|ui| {
                                ui.label("Shadows:");
