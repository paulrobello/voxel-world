...
make new-flat       # Reset and create flat world (seed 12345678)
make new-normal     # Reset and create normal world (seed 12345678)
```
...
- Positions 43-44: Birch tree blocks (BirchLog, BirchLeaves)
- Total: 45 textures in atlas (2880x64 pixels)
