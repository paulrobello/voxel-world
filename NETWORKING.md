...
| Compression | `lz4_flex` | 0.13 | Chunk data compression |
...
graph TD
    subgraph GameLayer["Game Layer"]
        CA["ClientApp<br/>- LocalPlayer<br/>- Input<br/>- Prediction"]
        SA["ServerApp<br/>- World (authoritative)<br/>- PlayerSessions<br/>- Physics Simulation"]
    end

    subgraph NetLayer["Networking Layer"]
        RC["RenetClient<br/>- Channels<br/>- Reliability"]
        RS["RenetServer<br/>- Channels<br/>- Broadcast/Unicast"]
    end

    subgraph TransportLayer["Transport Layer"]
        UDP["UDP via renet_netcode"]
    end
...
- [x] Server thread management (experimental -- disabled by default, enable via `USE_THREADED_SERVER`)
