...
**Arguments:**
- `biome` (optional): Biome name - grassland, mountains, desert, swamp, snow, or "all" for all biomes. Default: grassland
...
Creates an interactive HTML infographic showing:
- World height and layer structure (Y: 0-511)
- Sea level and surface height for the biome
...
The infographic is saved as `layer_viz_{biome}.html` in the project root.

## Biome Details

**Grassland**: Standard terrain at Y~128, 3-6 block dry cave window
**Mountains**: Peaks up to Y~190, lava lakes below Y=100, good cave range
**Desert**: All caves are dry (no water at any depth)
**Swamp**: Low terrain Y~124, extra flooding to Y=129, minimal dry caves
**Snow**: Tundra/peaks Y~128-170, standard water filling

---

## Implementation

When invoked, use this Python script to generate the visualization:
...
Save this as a Python script and run it with the biome name as an argument.
