...
auto-profile-flat: reset-world build-release
	./target/release/voxel-world --auto-profile --world-gen flat --seed $(SEED) --fly-mode $(ARGS)

auto-profile-normal: reset-world build-release
	./target/release/voxel-world --auto-profile --world-gen normal --seed $(SEED) --fly-mode $(ARGS)
