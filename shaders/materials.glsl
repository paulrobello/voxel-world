...
// Note: ATLAS_TILE_COUNT and ATLAS_TILE_SIZE are now in generated_constants.glsl
// (included via common.glsl) — generated from src/constants.rs by build.rs.
...
uint blockTypeToAtlasIndex(uint blockType) {
    ...
    switch (blockType) {
        ...
        case BLOCK_LAVA:
            return TEX_LAVA;
        case BLOCK_GLOW_STONE:
            return TEX_GLOWSTONE;
        case BLOCK_GLOW_MUSHROOM:
        ...
        case BLOCK_WILLOW_LEAVES:
            return TEX_WILLOW_LEAVES;  // Willow leaves have olive green drooping texture
        case BLOCK_ICE:
            return TEX_ICE;
        case BLOCK_MUD:
            return TEX_MUD;
